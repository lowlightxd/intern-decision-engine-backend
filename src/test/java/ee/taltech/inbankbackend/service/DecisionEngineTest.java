...
class DecisionEngineTest {
    ...
    void testLowCreditScore() throws InvalidLoanPeriodException, NoValidLoanException,
            InvalidPersonalCodeException, InvalidLoanAmountException, AgeNotInRangeException {
        assertThrows(NoValidLoanException.class, () -> decisionEngine.calculateApprovedLoan(segment2PersonalCode, 4000L, 12));
    }

    @Test
    void testInvalidAge() throws InvalidLoanPeriodException, NoValidLoanException,
            InvalidPersonalCodeException, InvalidLoanAmountException, AgeNotInRangeException {
        assertThrows(AgeNotInRangeException.class, () -> decisionEngine.calculateApprovedLoan(segment3PersonalCode, 4000L, 12));
    }
